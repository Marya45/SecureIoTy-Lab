...
//     { id: 3, ip: "192.168.56.103", name: "Attacker Pi" },
//   ];
...
function mitm() {
  ...
  const piAddresses = [
    { id: 1, ip: "192.168.56.103", name: "Raspberry Pi 1" },
    { id: 2, ip: "192.168.56.102", name: "Raspberry Pi 2" },
    { id: 3, ip: "192.168.56.101", name: "Attacker Pi (MITM)" },
  ];
  ...
  return (
    <div className="App">
      ...
      <h1 style={{color:'black'}}>Man-in-the-middle Attack Simulation</h1>
      <div className="network-diagram">
        <div
          className="attacker-container"
          onClick={() =>
            handlePiClick({ id: 3, ip: "192.168.56.101", name: "Attacker Pi" })
          }
        >
          <img src={`/pi-image.png`} alt="Attacker Pi" className="pi-image" />
          <p>Attacker Pi</p>
